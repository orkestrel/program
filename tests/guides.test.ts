...
const PACKAGE_NAME = '@orkestrel/program'
/** The one guide this package sources, whose tagline the README pitch equals. */
const GUIDE_SPEC = 'guides/program.md'
/** Each import specifier this package's own guides may resolve against. */
const MODULES = Object.freeze({ [PACKAGE_NAME]: 'src/core' })
/**
...
await new GuideCommand({
	...
	const { createQualificationDefinition, createRuling } = await import('@orkestrel/qualifier')
	const { buildLineDefinition, buildRatingDefinition } = await import('@orkestrel/rater')
	const {
		createAtom,
		createFactorGroup,
	...
	const { buildProgramDefinition, createProgram } = await import('@src/core')
